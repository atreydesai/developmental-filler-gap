...
WEIGHTS = {
    ...
    # BabyLM models (GPT-2 architecture uses float32)
    "BabyLM-community/babylm-baseline-100m-gpt2": float32,
}
...
parameters = {
    ...
    # "pythia-14m": 14000000,
    # BabyLM models
    "babylm-baseline-100m-gpt2": 124000000,  # ~124M params (GPT-2 base size)
}
