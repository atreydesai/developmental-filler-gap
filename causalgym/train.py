...
def train_das(
        ...
        model_id: str, dataset: str, epochs: int=1, das_label: str="das"):
    ...
    # === Modified ===
    # save model
    subfolder = f"pos_{pos_i}_layer_{layer_i}"
    model_id = model_id.split("/")[-1]
    intervenable.save(f"./intervention_models/{model_id}/{dataset}/{subfolder}/")
    # === End modified ===
    ...
    # === Modified ===
    # free memory
    del intervenable.model
    intervenable.model = None
